...
//  Swift-AGDS
//
//  Created by Derrick Park on 2023-04-11.
//
...
func sushi() {
  ...
  func removeLeavesNotRealSushi(from graph: Graph, v: Int, sushi: Set<Int>, visited: inout [Bool]) {
    visited[v] = true
  ...
  removeLeavesNotRealSushi(from: graph, v: start, sushi: realSushi, visited: &visited)
