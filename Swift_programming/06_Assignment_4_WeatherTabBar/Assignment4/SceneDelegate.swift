...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
  ...
  func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
    ...
    // 5 cities
    let vancouver = City(name: "Vancouver", country: "🇨🇦", temp: 15, precipitation: 95, icon: "canada", summary: "Rainy")
    let verona = City(name: "Verona", country: "🇮🇹", temp: 22, precipitation: 20, icon: "italy", summary: "Cloudy")
    let tokyo = City(name: "Tokyo", country: "🇯🇵", temp: 24, precipitation: 40, icon: "japan", summary: "Sunny")
    let saoPaulo = City(name: "Sao Paulo", country: "🇧🇷", temp: 32, precipitation: 20, icon: "brazil", summary: "Sunny")
    let seoul = City(name: "Seoul", country: "🇰🇷", temp: 35, precipitation: 50, icon: "skorea", summary: "Sunny")
